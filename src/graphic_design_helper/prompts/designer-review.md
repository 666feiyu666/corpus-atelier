...
the intended viewer, not merely whether it matches your previous image specification.
...
Revise your proposal or just its image specification as needed; your earlier concept is
provisional, while the macro brief stays the reference point. Keep successful choices.
Return the complete updated proposal, including image_spec for the next poster when
